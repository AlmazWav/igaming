      ...
      <header class="topbar" data-navbarbg="skin5">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin5">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <a class="navbar-brand" href="https://t.me/+KuEkcLNK3yJkNWEx">
              <!-- Logo icon -->
              ...
              <!--You can put here icon as well // <i class="wi wi-sunset"></i> //-->
              <!-- Dark Logo icon -->
              <!-- <img src="../assets/images/logo-text.webp" alt="homepage" class="light-logo" /> -->
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h4 class="text-white"><?php echo $result['saques'] ?></h4>
          ...
          <!-- ============================================================== -->
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  <h1 class="font-light text-white">
                    R$ <?php echo $result['saques_valor'] ?>
                  </h1>
        ...
        <div class="box bg-dark text-center">
            ...
            <form action="/adm/processos.php?opcao=dificuldadeJogo"  method="post" id="editForm3">  
                ...
                <select  name="valor" class="form-select custom-input" aria-label="Escolha a dificuldade">
                    ...
                    <option <?php echo ($result['dificuldade_jogo'] == 'impossivel') ? 'selected' : ''; ?> value="impossivel">Impossível</option>
                </select>
                <br>
                <br>
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h5 class="text-white">Saque Máximo</h5>
        <h7 class="text-white">R$</h7>
        <form action="processos.php?opcao=saqueMax" method="post" id="editForm3">  
            <input type="text" class="form-control custom-input" value="<?php echo $result['saques_max'] ?>" id="valorSaqueMax" placeholder="Digite o valor" name="valor" required>
            <br>
            <br>
            <button type="submit" class="btn btn-primary">Atualizar</button>
        </form>
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h5 class="text-white">Meta do Jogo</h5>
        <h7 class="text-white">X</h7>
        <form action="processos.php?opcao=xMeta" method="post" id="editForm3">  
            <input type="text" class="form-control custom-input" value="<?php echo $result['xmeta'] ?>" id="valorSaqueMax" placeholder="Digite o valor" name="valor" required>
            <br>
            <br>
            <button type="submit" class="btn btn-primary">Atualizar</button>
        </form>
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h5 class="text-white">Multiplicador dentro do Jogo</h5>
        <h7 class="text-white">Valor por Moeda</h7>
        <form action="processos.php?opcao=valorMoeda" method="post" id="editForm3">  
            <input type="text" class="form-control custom-input" value="<?php echo $result['valor_moeda'] ?>" id="valorMoeda" placeholder="Digite o valor" name="valor" required>
            <br>
            <br>
            <button type="submit" class="btn btn-primary">Atualizar</button>
        </form>
