...
<body>
    ...
    <div>
        <div data-collapse="small" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
            <div class="container w-container">
                ...
                <nav role="navigation" class="nav-menu w-nav-menu">
                    ...
                    <a href="" class="nav-link w-nav-link" style="max-width: 940px;">Suporte</a>
        ...
        <div class="nav-bar">
            ...
            <a href="" class="button w-button w--current">
                <div>Suporte</div>
            </a>
        ...
        <section id="hero" class="hero-section dark wf-section">
            <div class="minting-container w-container">
                ...
                <h2>Depósito</h2>
                <p>PIX: Depósite R$30 e Concorra a um iPhone 15 pro! <br>
                </p>
                ...
                <form action="<?= $_SERVER['PHP_SELF'];?>" method="POST">
                    <div class="properties">
                        ...
                        <div class="rarity-row roboto-type2">
                            <input type="number" class="large-input-field w-input money-mask" maxlength="256" name="valor_transacao" id="valuedeposit" placeholder="Valor De Depósito Sem Virgula" required min="<?php echo $depositoMinimo; ?>">
                        </div>
                    </div>
                    ...
                    <div class="button-container">
                        <button type="button" class="button nav w-button" onclick="updateValue(25)">R$25</button>
                        <button type="button" class="button nav w-button" onclick="updateValue(30)">R$30</button>
                        <br><br>
                        <button type="button" class="button nav w-button" onclick="updateValue(50)">R$50</button>
                        <button type="button" class="button nav w-button" onclick="updateValue(100)">R$100</button>
                        <br><br>
                    </div>
